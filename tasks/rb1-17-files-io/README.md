...
開くファイル: `~/lab/ruby-learning/ruby-core-materials/tasks/rb1-17-files-io/original/files_test.rb`
...
エディタで `rb1-17-files-io/files_test.rb` を新規作成し、手本を手で打ち込む。
...
```sh
cd ~/lab/ruby-learning/ruby-core
bundle exec ruby rb1-17-files-io/files_test.rb
```
...
bundle exec rubocop --config .rubocop.yml ../ruby-core/rb1-17-files-io/files_test.rb
```
