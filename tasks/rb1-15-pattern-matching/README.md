...
開くファイル: `~/lab/ruby-learning/ruby-core-materials/tasks/rb1-15-pattern-matching/original/pattern_matching.rb`
...
`copy_test/pattern_matching_test.rb` にある。**写さない。読んでよい。**
...
エディタで `rb1-15-pattern-matching/pattern_matching.rb` を新規作成し、手本を手で打ち込む。
...
bundle exec rubocop --config .rubocop.yml ../ruby-core/rb1-15-pattern-matching/pattern_matching.rb
```
...
結果は `~/lab/ruby-learning/docs/grading/rb1-15-pattern-matching.md` に残る（成果リポには置かない）。
