...
> `/why-review rb1-07-collections-enumerable`
...
走らせると、教材リポの claim 表（`tasks/rb1-07-collections-enumerable/claims.yml`）と `why.md` を突き合わせ、
...
結果は `~/lab/ruby-learning/docs/grading/rb1-07-collections-enumerable.md` に残る（成果リポには置かない）。
