...
> `/why-review rb1-19-optparse-executable`
...
走らせると、教材リポの claim 表（`tasks/rb1-19-optparse-executable/claims.yml`）と `why.md` を突き合わせ、
...
結果は `~/lab/ruby-learning/docs/grading/rb1-19-optparse-executable.md` に残る（成果リポには置かない）。
