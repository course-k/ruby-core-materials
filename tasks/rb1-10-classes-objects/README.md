...
> `/why-review rb1-10-classes-objects`
...
走らせると、教材リポの claim 表（`tasks/rb1-10-classes-objects/claims.yml`）と `why.md` を突き合わせ、
...
結果は `~/lab/ruby-learning/docs/grading/rb1-10-classes-objects.md` に残る（成果リポには置かない）。
